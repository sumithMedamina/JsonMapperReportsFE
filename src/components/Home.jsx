          ...
          >
            <button
              className={`btn btn-primary mb-4 ${
                activeComponent === "RestEndpoint" ? "active" : ""
              }`}
            ...
            <button
              className={`btn btn-warning mb-4 ${
                activeComponent === "SchemaBuilder" ? "active" : ""
              }`}
            ...
            <button
              className={`btn btn-info mb-4 ${
                activeComponent === "JsonMapper" ? "active" : ""
              }`}
            ...
            <button
              className={`btn btn-success mb-4${
                activeComponent === "Rebrand" ? "active" : ""
              }`}
            ...
            <button
              ...
              title="Reports"
            > 
              <RiArticleLine className="me-2" /> Reports
            </button>
          </div>
        </div>
